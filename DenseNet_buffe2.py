...
dir = pathlib.Path(ruta_bin)


ficheros = [fichero.name for fichero in dir.iterdir()]
...
buf_cero.to_excel('DenseNet_buffer2.xlsx', sheet_name='fichero_707_buffer2', index=False)
