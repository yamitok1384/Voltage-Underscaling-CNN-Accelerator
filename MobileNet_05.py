...
save_obj(Baseline_Acceses,'Data/Acceses/MobileNet/Baseline_05')
save_obj(CNN_gating_Acceses,'Data/Acceses/MobileNet/CNN_gating_Adj_05')
...
save_obj(Accs_x,'Data/Errors/MobileNet/Colorectal Dataset/Accs_x_05')
...
#buf_cero.to_excel('resultado.xlsx', sheet_name='ceros_705', index=False)
...
buf_cero.to_excel('resultado_MobileNet_05.xlsx', sheet_name='fichero_705', index=False)
