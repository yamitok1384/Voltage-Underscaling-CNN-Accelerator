...
Net = GetNeuralNetworkModel('ZFNet', (224, 224, 3), 8, aging_active=activation_aging,faulty_addresses=locs, masked_faults=error_mask_new,
...
print(df_concat)
df_concat.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/bins/ZFNet_new_bins_test_LO_mask.xlsx', sheet_name='fichero_707', index=False)
