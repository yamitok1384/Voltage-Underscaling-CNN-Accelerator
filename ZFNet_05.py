...
save_obj(Baseline_Acceses,'Data/Acceses/ZFNet/Baseline_v2_05')
save_obj(CNN_gating_Acceses,'Data/Acceses/ZFNet/CNN_gating_Fix_v2_05')
...
buf_cero.to_excel('resultado_ZFNet_05.xlsx', sheet_name='fichero_705', index=False)
