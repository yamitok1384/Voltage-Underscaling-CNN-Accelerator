...
# loss_a_w, acc_a_w = CheckAccuracyAndLoss('AlexNet', test_dataset, wgt_dir, output_shape=8, input_shape=(227, 227, 3),
#                                      act_frac_size=11, act_int_size=4, wgt_frac_size=11, wgt_int_size=4,
...
print('accurancy inyectando solo en pesos 1',Accs_w)
print('perdida inyectando solo en pesos 1',Loss_w)
...
loss_w_1, acc_w_1 = CheckAccuracyAndLoss('AlexNet', test_dataset, wgt_dir, output_shape=8, input_shape=(227, 227, 3),
                                     act_frac_size=11, act_int_size=4, wgt_frac_size=11, wgt_int_size=4,
                                     batch_size=testBatchSize, verbose=0, aging_active=False, weights_faults=True,
                                     faulty_addresses=locs, masked_faults=error_mask)
...
print('accurancy inyectando solo en pesos 1',Accs_w_1_0)
print('perdida inyectando solo en pesos 1',Loss_w_1_0)
print('activaciones pesos en 1 aging_active = False, weights_faults = True', Accs_w_1_0)
print('perdida pesos en 1 aging_active = False, weights_faults = True',Loss_w_1_0)
print('nan en perdidas aging_active = False, weights_faults = True',np.isnan(Loss_w_1_0))
print('nan en accurancy aging_active = False, weights_faults = True',np.isnan(Accs_w_1_0))
# #
#
...
# buf_cero.to_excel('resultado_AlexNet.xlsx', sheet_name='fichero_707', index=False)
